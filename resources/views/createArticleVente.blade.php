...
<tr>  
<td> <input style= "border:none"  value="{{$article->id_article}}" name="id_article" disabled></td>
<td> <input style= "border:none"  value="{{$article->designation}}"  disabled></td> 
<td> <input style= "border:none"  value="{{$article->unite_stock}}"  disabled></td>
<td> <input style= "border:none"  value="{{$article->marque}}"  disabled></td>
<td>  <input style= "border:none"  value="{{$article->ventes->prix ?? ''}}"  disabled> </td>
<td> <input style= "border:none"  value="{{$article->ventes->prix_min ?? '' }}"  disabled></td>

    <td style=" display: flex;">
    <button type="button" class="button" style ="background: blue" onclick="document.getElementById('articl-id-inp').value={{$article['id_article']}}" data-toggle="modal" data-target="#myModal"><span class="button__icon"><ion-icon name="save-outline"></ion-icon> </span></button>
    <button type="button" class="button edit" value ="{{$article->ventes->id_vente ?? ''}}"><span class="button__icon"> <ion-icon name="create-outline"></ion-icon> </span></button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">informations de vente </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
      <form action="createArticleVente" class="form-horizontal" method="POST">
  @csrf   
...
<div class="form-group row">
<div class="col-lg-4 text-lg-right">
<label  class="col-form-label">prix_min *</label>
</div>
<div class="col-lg-4">
<input type="text"  name="prix_min" class="form-control">
@error('prix_min')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
</div>
...
<div class="modal" id="editModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">update vente informations  </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <!-- Modal body -->
      <div class="modal-body"> 
      <form action="updateVenteInfo/{{$article->id}}" class="form-horizontal" method="POST" id="editform">
      @method('PUT')
      @csrf
...
<input style= "border:none"  type="hidden"   value ="{{$article->ventes->id_vente ?? ''}}"  name="id_vente" id="id_vente">
<div class="form-group row">
<div class="col-lg-4 text-lg-right">
<label  class="col-form-label">prix_min *</label>
</div>
<div class="col-lg-4">
<input type="text"  name="prix_min" id="prix_min" class="form-control">
@error('prix_min')
    <div class="alert alert-danger">{{ $message }}</div>
@enderror
</div>
...
$(document).on('click', '.edit', function() { 
    var id_vente = $(this).val();
    $('#editModal').modal('show');

    $.ajax({
    type : "GET",
    url : "/updateVenteInfo/"+id_vente,
     success: function (response){ 
      $('#prix').val(response.vente.prix);
      $('#prix_min').val(response.vente.prix_min);
      $('#id_vente').val(id_vente);
