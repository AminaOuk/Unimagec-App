...
<li>
<a href="/createArticleAchat">
<i class="fa fa-file"></i>
<span class="link-title menu_hide">&nbsp;les demandes</span>
</a>
</li>
</ul>
</div>
...
<tr>
    ...
    <td><input style= "border:none" type="text" value="{{$article->achats->Code_fornisseur ?? ''}}" disabled> </td>
    <td> <input style= "border:none" type="text" value="{{$article->achats->unite_achat ?? ''}}" disabled></td>
    <td> <input style= "border:none" type="text" value="{{$article->achats->designation_achat ?? ''}}" disabled></td>
    <td> <input style= "border:none" type="text" value="{{$article->achats->prix_achat ?? ''}}" disabled></td>
    ...
    <button type="button" class="button edit" value ="{{$article->achats->Code_fornisseur ?? ''}}"><span class="button__icon"> <ion-icon name="create-outline"></ion-icon> </span></button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">informations d'achat </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
      <form action="createArticleAchat" class="form-horizontal" method="POST">
  @csrf 
  <div class="form-group row">
  <div class="col-lg-4 text-lg-right">
  <label  class="col-form-label"> Code fournisseur *</label>
</div>
<div class="col-lg-4">
<input type="text"  name="Code_fornisseur" class="form-control">
</div>
</div>  
<div class="form-group row">
<div class="col-lg-4  text-lg-right">
<label class="col-form-label"> Unité d'achat *</label>
</div>
<div class="col-lg-4">
<select class="form-control" style="width:140px ; margin-left:-1px" name="unite_achat">
...
<div class="form-group row">
<div class="col-lg-4 text-lg-right">
<label  class="col-form-label">Désignation d'achat *</label>
</div>
<div class="col-lg-4">
<input type="text"  name="designation_achat" class="form-control">
</div>
</div>
...
<div class="modal" id="editModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">update achat informations  </h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <!-- Modal body -->
      <div class="modal-body"> 
      <form action="updateAchatInfo/{{$article->Code_fornisseur}}" class="form-horizontal" method="POST" id="editform">
      @method('PUT')
      @csrf
      
<div class="form-group row">
<div class="col-lg-4  text-lg-right">
<label class="col-form-label">  Code fornisseur *</label>
</div>
<div class="col-lg-4">
<input type="text" id="Code_fornisseur" name="Code_fornisseur" value ="{{$article->achats->Code_fornisseur ?? ''}}" class="form-control" disabled >
</div>
</div>
<div class="form-group row">
<div class="col-lg-4 text-lg-right">
<label  class="col-form-label">unite_achat *</label>
</div>
<div class="col-lg-4">
<select class="form-control" style="width:140px ; margin-left:-1px" id="unite_achat" name="unite_achat">
<option value="">Select</option> 
  <option value="COLIS">COLIS</option>
  <option value="ENS">ENS</option>
  <option value="KG">KG</option>
...
<div class="col-lg-4">
<input type="text"  name="designation_achat" id="designation_achat" class="form-control">
</div>
</div>
<div class="form-group row">
<div class="col-lg-4 text-lg-right">
...
<div class="col-lg-4">
<input type="text" id="prix_achat"  name="prix_achat" class="form-control">
</div>
</div>
...
$(document).on('click', '.edit', function() { 
    var Code_fornisseur = $(this).val();
    $('#editModal').modal('show');

    $.ajax({
    type : "GET", 
    url : "/updateAchatInfo/"+Code_fornisseur,
     success: function (response){ 
      $('#unite_chat').val(response.achat.unite_achat);
      $('#prix_achat').val(response.achat.prix_achat);
      $('#designation_achat').val(response.achat.designation_achat);
      $('#Code_fornisseur').val(Code_fornisseur);
    }
  });
});
}); 
