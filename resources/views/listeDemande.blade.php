...
<head>
<meta charset="UTF-8">
<title>Unimagec  | liste des demandes </title>
...
<table id="dtHorizontalVerticalExample" class="table table-striped table-bordered table-sm " cellspacing="0"
  ...
  <form>
<tr>
    <td> <input style= "border:none" type="text" disabled></td>
    <td> <input  style= "border:none" type="text" disabled ></td>
    <td> <input  style= "border:none" type="text" disabled ></td>
    <td> <input style= "border:none" type="text" disabled></td>
    <td> <input type="range" value="0">
<div id="h4-container"><div id="h4-subcontainer"></div></div></td>
