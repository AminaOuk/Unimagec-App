...
<head>
<meta charset="UTF-8">
<title> Unimagec| UserProfile </title>
...
Lock Screen</a>
<a class="dropdown-item" href="{{ route('achat.logout') }}" onclick="event.preventDefault();
  document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i>
Log Out</a>
<form id="logout-form" action="{{ route('achat.logout') }}" method="POST" class="d-none">
   @csrf
</form> 
</div>
</div>
