...
<tr>
  ...
  <option value="2">ENS</option>
  <option value="3">KG</option>
  <option value="4">LITRE</option>
  <option value="5">m2</option>
  <option value="6">m3</option>
  <option value="7">METRE LINEAIRE</option>
  <option value="8">PALETTE</option>
  <option value="9">PIECE</option>
  <option value="10">Tonne</option>
  <option value="11">Toure en bois</option>
</select>*
</td>
    <td> <input type="text"></td>
    <td> <input type="text"></td>
